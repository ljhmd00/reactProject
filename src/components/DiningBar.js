...
function DiningBar(){
    return(
        <div className="bar" style={{marginTop:''}}>
            <video src={videoBg} autoPlay loop muted  style={{height:'30%',height:'400px'}}/>
            ...
            <div style={{textAlign:'center',margin:'30px'}}>
                ...
                <Card style={{margin:'20px',width:'600px'}}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <p><span style={{fontSize:'18px'}}>이용시간: </span>am:07:00 ~ 10:00</p>
                            <p><span style={{fontSize:'18px'}}>위치: 호텔 3층</span></p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                ...
                <Card style={{margin:'20px',width:'600px'}}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <p><span style={{fontSize:'18px'}}>이용시간: </span>pm:17:00 ~ 21:00</p>
                            <p><span style={{fontSize:'18px'}}>위치: 호텔 3층</span></p>
                        </Card.Text>
                    </Card.Body>
                </Card>
                ...
                <Card style={{margin:'20px',width:'600px'}}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <p><span style={{fontSize:'18px'}}>이용시간: </span>pm:20:00 ~ 24:00</p>
                            <p><span style={{fontSize:'18px'}}>위치: 호텔 8층</span></p>
                        </Card.Text>
                    </Card.Body>
                </Card>
